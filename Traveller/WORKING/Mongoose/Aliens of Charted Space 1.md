...
revelation and is happier for it.
...
the system or being good at a non-leadership role. A bureaucrat who eventually becomes head-penpusher in
...
for a lone Aslan to kill and they began hunting in _ahriy_ (prides) of several families. The strongest male became
...
claw under each thumb; this dewclaw folds back jack-knife fashion into a horny covering in the base of the
...
An individual Aslan is usually a member of a family ( ekho ) of 2–12 persons under a patriarchal leader. This
...
his family their fealty. A number of prides form a clan (huiha), with one pride dominant. Again, prides in the
...
resolved, especially if rituals and other tension-relieving forms fail to defuse the problem. Duels follow
...
by the Aslan, the humans were now chattels of a land-owning male. The Aslan warrior now respected the
...
social level in combat units have some chance of social (and hence military) advancement, while those in non-combatant arms have virtually none.
...
since there are usually more landless males (lower-class and ihatei alike) than there are positions in a
...
opposite extreme, an Aslan lower in the social order (but still a noble) might be named HlyueawifiyAhroay'
...
clients. Needless to say, while formal or ritual speech (which is frequent) calls for Aslan to use their full
...
Aslan-sounding words is provided. This neatly avoids all considerations of syntax and vocabulary. Simply generate
...
Wind'. Since Aslan does not translate well into English (most Aslan words are an entire phrase of meaning,
...
hundreds of glyphs called _Tao_. These glyphs were
...
knowledge of only three dozen common _Tao_.

A scientific form of _Tao_ is used by females for technical
purposes. On board an Aslan ship, consoles used by
males will use simplified, traditional _Tao_ , while female
...
#### Pronunciations
This table is a guide to Aslan speech
...
#### AUA'KA
	...
	ANIMAL HITS SPEED
	Aua'ka 64 5m
	SKILLS Athletics (strength) 3, Melee (natural) 2, Recon 1, Survival 3
...
#### KHTA
	ANIMAL HITS SPEED
	Khta 28 10m
	SKILLS Athletics (dexterity) 2, Melee (natural) 1, Survival 1
...
horses but they are primarily carnivorous. They are foul-tempered beasts and have a taste for human flesh.
...
that Aslan male. It is the foundation of Aslan SOC - for a landless male or female, his or her SOC is
...
Clan table, or the Referee may choose to dictate which clan the Traveller comes from. Note that if any Travellers
...
your family of all territory. Gain Independence
    0 (if male) or Profession0 (if female). Lose all
Ancestral Territory
...
much of your land. Gain Gamble 0 or Carouse 0. –3 Ancestral Territory
...
The material on [[#Aslan Language]]  gives some basic
...
### Ceremonial
The Aslan have a rich cultural heritage.
...
### Outcast
 Outcast Travellers, for one reason or another,
...
Some Outcasts become Outlaws, travelling
...
Travellers involved in the pursuit of the sciences (whether biological, physical, or social) can become
...
Many _ihatei_ are given vessels
...
The Aslan deal with skills primarily on a gender basis - males feel that some skills are dishonorable and
...
traditionally a female responsibility and males (particularly upper-class males) rarely understand
...
Realising a Price is Extortionate : Average (8+) Independence check (INT or EDU)
Understanding an Economics Treatise : Difficult (10+) Independence check (1D x 10 minutes, INT)
...
Some skills can be learned in Aslan society
...
Some skills can be learned in Aslan
...
These skills may be learned by Aslan but are
extremely rare.
...
### MILITARY
		...
		**RANK WARRIOR/FLYER/CAVALRY SKILL OR BENEFIT SUPPORT SKILL OR BENEFIT**
		...
		9 An officer insults your courage. You may either duel him or try to prove him wrong. If you duel him, roll Melee (natural) 8+. If you succeed, gain SOC +1. If you fail, lose SOC –1. If you instead try to prove him wrong, roll 1D.
...
### SCIENTIST
		...
		**2D EVENT**
		...
		subject's secrets and gain DM+2 to your next advancement roll. If you fail, suffer DM-2 to your next ad-vancement roll.
...
A Traveller may trade Clan Shares for simple
    cash. Each Clan Share gives the Traveller Cr10000.
### - Corporation

The Traveller owns an operating
...
Clan Shares can be kept in reserve, and
...
This option can only be taken by a male Aslan
...
Clan Shares may be converted to Ship
...
After having aimed for at least
    two rounds
### - Gun Combat (slug)
...
You have an encounter with a psionic phenomenon, such as a human psionic institute, a
...
You come into possession of a curious piece of alien technology or an
...
as most weapons, are simplified to the point of elegance (or beyond). A human laser rifle has a wealth of options
...
These ornamental breastplates are designed to deflect the razor-sharp dewclaws of an attacker, and are not strong enough to stand
...
actuators to aid the wearer's movements, as well as a limited built-in artificial intelligence to advise male wearers on correct operation.
...
struck by a modern assassin's blade must make a Difficult (10+) END check or suffer another 1D damage every hour for
the next 1D hours.
...
A combination of spear (at one end) and four-pronged grappling hook (at the other), the yurletya is 250cm in length and was a favorite
...
_wye'oiheasarl_ is fired much like a flamethrower, vomiting a stream of star-hot matter over a wide area. Proper use of the wye'oiheasarl requires proper
...
flatbed carrier. This reduces Passengers to 1 (to sit alongside the driver) but increases Cargo
capacity to 8 tons.
...
System (enhanced), Navigation System (improved), Sensor System (improved)
...
Sensors (Electronics (sensors) DM) +4
Camouflage (Recon
DM) –4
...
encryption, meson communicator, satellite uplink, tightbeam), Computer /5, Control System (advanced), Electronic Countermeasures (advanced), Electrostatic Armor, Fire Extinguishers,
...
their territory. The barge hovers using anti-gravity suspensors but is propelled by sails or
...
There is a strong tradition that 'the
...
Aslan with time on their dewclaws
enjoy telling stories of their exploits and adventures.
During the long days of a space journey, the passengers (and crew with no immediate jobs to perform) meet in
...
Because of expectations within Aslan
...
A female Aslan will never suffer penalties for using male-configured controls (although she will likely become
frustrated at their simplicity), but male Aslan using female-configured controls suffer DM-2 to all relevant checks.
...
The ihateisho is capable of making four-parsec jumps, allowing it to reach systems
...
the Ktiyhui -class courier is a fast, long-range ship used to conduct clan business
...
similar ships, there are four staterooms - more than the crew needs but Kteriroa are commonly also used as transports in isolated systems.
...
correct caste
    2 First wife and establishment of household: Easy (4+) Patriarchy check
...
Bite, Heightened Senses (see page 51 of the
...
**_1. Bridge
    ...
    5. J-Drive
    6. Power plant
    7. Double turret (beam lasers)
    8. Double turret (sandcaster)
    9. Staterooms
    10. High stateroom
    11. Luxury stateroom
    12. Cargo hold
...
**_1. Bridge
    ...
    5. J-Drive
    6. Power plant
    7. Triple turret (pulse lasers)_**
    **_8. Triple turret_**
    **_(missile racks)_**
    **_9. Staterooms_**
...
**_1. Bridge
    ...
    4. J-Drive
    5. Power plant
    6. Single turret (beam lasers)
    7. Single turret (missile racks)_**
    **_8. Single turret_**
    **_(sandcasters)_**
    **_9. Low Berth_**
    **_10. Medical bay_**
...
**_1. Bridge
    ...
    4. J-Drive
    5. Power plant
    6. Triple turret (beam lasers)
    7. Triple turret (missile racks)_**
    **_8. Missile storage_**
    **_9. Low Berth_**
    **_10. Medical bay_**
    **_11. Staterooms_**
...
local conditions, is essentially the same from planet-to-planet across its expanse.
...
concerned (Morality's Path recognizes spirits and duty of other races but has little to say about them). When
...
for thousands of years. One of the foremost values (which Imperial humans notice most quickly) is the
...
they are proficient enough to possess mind-shields (usually as early adolescents) and have earned the right
...
do their jobs and enjoy happy lives, Proles with more ambition may seek to excel within a discipline, be it
...
management, supervisory or non-commissioned officer (NCO) positions that involve supervising other Proles
...
institutes, the military, professions that require psionics (including psychologists, sociologists and teachers) or
...
These do not come with hereditary government positions (which are elective) but correlate with the influence (and
...
materials to a lender or forgetting an appointment with a Noble. For minor cases, the punishment is a small
...
because of a character flaw or subconscious fault. Re-education uses psychological and psionic techniques to
...
committed. If there are multiple Nobles on a council with telepathic abilities, the case will go to whichever
...
reprogrammable machine tools that remain fixed in place. Zhodani use industrial robots but also mobile
...
psionic training, however, and although they hold officer-equivalent rank, they are not in the chain of command
...
Technicians, drivers, gunners, non-commissioned officers (NCOs) and so on are Proles. The Zhodani have also long
...
Zhof wears standard Consulate-issue non-power-assisted combat armor. Lighter than its Imperial
...
covert operations as an adjunct to other operations was no longer practical. With the need for a dedicated
...
Survival. If SOC 10+, gain an Enemy as the government buries the whole incident. If Soc 9-, roll on the Re-education Events table (page 274).
...
you out of the Army. If SOC 9-, roll on the Re-education Event table (page 274).
    ...
    4 You are assigned to a world with a hostile or wild environment. Gain one level of Vacc Suit, Engineer, Animals (riding or training) or Recon.
...
on the Injury table. If successful, you may continue in this career.
    5 A foreign ambassador insults you. Roll Diplomat 8+ to avoid a diplomatic incident. If failed, roll on the Re-education Events table (page 274) and leave this career. If successful, gain an extra Benefit roll.
...
SOC 10+, you may leave this career (mustering out as normal) and then automatically qualifies for the Agent (thought police) career (with the same rank) in the next term.

    6 You are assigned to an assault on an enemy fortress. Roll Melee or Gun Combat 8+. If successful, gain Tactics (military) or Leadership. If failed, you are injured; roll on the Injury table.
...
protect your commander, gain the commander as an Ally.
    ...
    11 Your commanding officer takes an interest in your career. Either gain one level of Leadership or Tactics (military), or gain DM+2 to your next Advancement roll thanks to his aid.
...
**1D MISHAP**
    ...
    2 One of your co-workers develops hatred towards you, sabotaging your life. Gain an Enemy and roll on the Re-education Event table (page 274).
...
current career.
    11 Crime: You commit or is accused of a crime; roll SOC 8+. If failed, lose one Benefit roll and roll on the Re-education Events table below.
...
career is not affected.
    5 Fine of Cr1000 x 1D; you do not require re-education.
    6 Exonerated! Receive an additional Benefit roll in
your current career.

### Anagathics

Use the number of terms since you started
taking anagathics as a negative DM to rolls on the Re-education Events table.
...
You receive a Yetsasl courier with 25% of the
...
The Nenjchinzhe'driante (the Consular Legion of
...
checks equal to half the blocking psion's current PSI (rounding down).
...
so forth. Machines can be switched on or off and their functions changed, as long as the device is capable
...
armor or a personal vehicle) may only have psi-sensitive switches, safeties or triggers.
...
Technological devices produced in
Zhodani territory contain integral psi-sensitive controls (in addition to regular controls), which allow operation
...
**GUARDS COMBAT ARMOR**
Guards combat armor is based on the earlier officer model (including the Computer/3) but has been further improved
...
each ending in complex tool-hands, and a small wedge-shaped head turret, and relies on its grav system for mobility.
Manufactured by Chiadle, it is the most common general-purpose repair and maintenance robot used in Zhodani space.
...
ways, ranging from mass assault to mobile fire support platforms to providing security perimeters or post-battle pursuit. They are vital for clearing built-up areas,
...
Fire Extinguisher, Life Support (short term), Navigation System (improved), Sensor System (improved), Vacuum Protection
...
Autopilot (advanced), Camouflage (advanced), Communication System (advanced, encrypted, increased range, tightbeam), Computer/3, Control System (advanced), ECM (advanced), Fire Extinguisher, Life Support (short term),
Navigation System (improved), Prismatic Aerosol Discharger, Sensor System (improved), Stealth (improved), Vacuum Protection
...
Autopilot (advanced), Bunks, Camouflage (advanced), Communication System (advanced, encrypted, increased range, tightbeam), Computer/3, Control System (advanced), Ejection Seats x 2, Fire Extinguisher, Life Support (short term),
Navigation System (improved), Sensor System (improved, high fidelity), Stealth (improved), Vacuum Protection
...
Anti-missile System (advanced laser), Autopilot (advanced), Camouflage (advanced), Communication System (advanced, encrypted, increased range,
...
System (advanced), Prismatic Aerosol Discharger, Sensor System (advanced), Stealth (advanced), Vacuum Protection
...
Anti-missile System (laser), Autopilot (enhanced), Bunks, Camouflage (advanced), Communication System (advanced, encrypted, tightbeam),
...
Navigation System (improved), Prismatic Aerosol Discharger, Sensor System (improved, sensor mast), Stealth (improved), Vacuum Protection
...
and scientific missions and less to courier-type duties than its Imperial counterpart
